...
abstract class Index extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \BlueOcean\BlueOceanPay\Helper\Data
     */
    private $helper;

    /**
     * @var \BlueOcean\BlueOceanPay\Helper\Validator
     */
    private $validator;

    /**
     * @var \BlueOcean\BlueOceanPay\Helper\Utilities
     */
    private $utilities;
    ...
    public function setHelper(\BlueOcean\BlueOceanPay\Helper\Data $helper)
    {
        $this->helper = $helper;
    }

    public function setValidator(\BlueOcean\BlueOceanPay\Helper\Validator $validator)
    {
        $this->validator = $validator;
    }

    public function setUtilities(\BlueOcean\BlueOceanPay\Helper\Utilities $utilities)
    {
    ...
    public function __construct(
        ...
        $this->setHelper($object_manager->create('BlueOcean\BlueOceanPay\Helper\Data'));
        $this->setValidator($object_manager->create('BlueOcean\BlueOceanPay\Helper\Validator'));
        $this->setUtilities($object_manager->create('BlueOcean\BlueOceanPay\Helper\Utilities'));
